...
ap.add_argument("-lk", "--link", required=True,
                help="link to web search")

args = vars(ap.parse_args())

# Search and download images
def search_and_download(search_term:str,driver_path:str,link:str,number_images=5,target_path='./images'):
    ...
    with webdriver.Chrome(executable_path=driver_path) as wd:
        res = fetch_image_urls(search_term, link, int(number_images), wd=wd, sleep_between_interactions=0.5)
...
# Get image links
def fetch_image_urls(query:str, link:str, max_links_to_fetch:int, 
    ...
    while image_count < max_links_to_fetch:
        ...
        thumbnail_results = wd.find_elements_by_css_selector("img.nofocus")
        ...
        for img in thumbnail_results[results_start:number_results]:
            ...
            # Extract image urls    
            actual_images = wd.find_elements_by_css_selector('img.nofocus')
...
search_and_download(args["searchterm"],args["driverpath"],args["link"],args["numofimages"],args["output"])
